...
class BaseLabelEncodingRule(abc.ABC):  # pragma: no cover
    ...
    @abc.abstractmethod
    def fit(self, df: PandasDataFrame) -> "BaseLabelEncodingRule":
        raise NotImplementedError()

    @abc.abstractmethod
    def partial_fit(self, df: PandasDataFrame) -> "BaseLabelEncodingRule":
        raise NotImplementedError()

    @abc.abstractmethod
    def transform(self, df: PandasDataFrame) -> PandasDataFrame:
        raise NotImplementedError()

    @abc.abstractmethod
    def inverse_transform(self, df: PandasDataFrame) -> PandasDataFrame:
        raise NotImplementedError()
...
class LabelEncodingRule(BaseLabelEncodingRule):
    ...
    def fit(self, df: PandasDataFrame) -> "LabelEncodingRule":
        """
    ...
    def partial_fit(self, df: PandasDataFrame) -> "LabelEncodingRule":
        """
    ...
    def save(
        ...
        encoder_rule_dict = {"_class_name": self.__class__.__name__, "init_args": {
            "column": self._col,
...
class LabelEncoder:
    ...
    def fit(self, df: PandasDataFrame) -> "LabelEncoder":
        """
    ...
    def partial_fit(self, df: PandasDataFrame) -> "LabelEncoder":
        """
    ...
    def fit_transform(self, df: PandasDataFrame) -> PandasDataFrame:
        """
