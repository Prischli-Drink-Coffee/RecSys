...
class Dataset:
    """
    dataset for feeding data to models.
    """
    ...
    @property
    def interactions(self) -> PandasDataFrame:
        """
    ...
    @property
    def query_features(self) -> Optional[PandasDataFrame]:
        """
    ...
    @property
    def item_features(self) -> Optional[PandasDataFrame]:
        """
    ...
    @property
    def query_ids(self) -> PandasDataFrame:
        """
    ...
    @property
    def item_ids(self) -> PandasDataFrame:
        """
    ...
    def _to_parquet(self, df: PandasDataFrame, path: Path) -> None:
        """
    ...
    def _get_feature_source_map(self):
        self._feature_source_map: Dict[FeatureSource, PandasDataFrame] = {
    ...
    def _get_ids_source_map(self):
        self._ids_feature_map: Dict[FeatureHint, PandasDataFrame] = {
    ...
    @staticmethod
    def _set_features_source(feature_list: List[FeatureInfo], source: FeatureSource) -> None:
...
def nunique(data: PandasDataFrame, column: str) -> int:
    """
...
def select(data: PandasDataFrame, columns: Sequence[str]) -> PandasDataFrame:
    """
    :param data: dataframe.
...
def check_dataframes_types_equal(dataframe: PandasDataFrame, other: PandasDataFrame):
    """
